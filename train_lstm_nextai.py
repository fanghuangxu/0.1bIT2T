...
CFG = {
    "vocab_size": 1024,
    "d_model": 384,       # 进一步增大: 提升学科区分能力
    "hidden_size": 384,   # 进一步增大: 提升学科区分能力
    "n_layers": 3,         # 增加层数: 增强领域区分能力
    "max_len": 250,       # 增大支持长文本输出
    "dropout": 0.15,      # 增加dropout: 减少过拟合
    "lr": 2e-4,           # 降低学习率: 更稳定的训练
    "batch_size": 16,     # 减小batch: 减少领域混淆
    "rounds": 20,         # 增加轮数: 更好的领域区分
...
def load_code_data(max_samples=2000):
    ...
    built_in_code = [
        ...
        ("C++ function to create simple shell", "#include <iostream>\n#include <string>\n#include <cstdlib>\nusing namespace std;\nint main() {\n    string cmd;\n    while (true) {\n        cout << '> ';\n        getline(cin, cmd);\n        if (cmd == 'exit') break;\n        system(cmd.c_str());\n    }\n    return 0;\n}"),
        ...
        ("JavaScript function to reverse string", "function reverseString(s) {\n    return s.split('').reverse().join('');\n}"),
        # Go
...
def main():
    ...
    test_samples = [
        ...
        ("你的名字是什么？", "我的名字是NextAI。"),
        ("What is your name?", "My name is NextAI."),
        ("Who are you?", "I am NextAI"),
        ("Are you human?", "No, I am NextAI"),
        ("translate to English: 你好", "Hello"),
        ("translate to English: 谢谢你", "Thank you"),
        ("翻译成中文：Hello", "你好"),
        ("Q: 什么是人工智能？", "人工智能"),
